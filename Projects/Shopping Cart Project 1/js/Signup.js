...
function SignupModal() {
	...
	modalInner += "</div><div class='modal-body'><div class='input-group input-group-lg'>";
  	modalInner += "<input type='text' id='modalEmail' class='form-control' placeholder='Email' size='45' aria-describedby='sizing-addon1'>";
	modalInner += "</div><div class='input-group input-group-lg' style='margin-top: 25px;'>";
  	modalInner += "<input type='password' id='modalPassword' class='form-control' placeholder='Password' size='45' aria-describedby='sizing-addon1'>";
